...
/*
 * Computes the value of 1D Gaussian at point x.
 * @param (x) value at which gaussian is to be computed
 * @param (mu) mean of gaussian
 * @output (sigma) stddev of gaussian
 */
inline double compute_gaussian(double x, double mu, double sigma) {
	double value = 1.0;
	double numerator = exp(-0.5 * (x-mu) * (x-mu)/(sigma*sigma) );
